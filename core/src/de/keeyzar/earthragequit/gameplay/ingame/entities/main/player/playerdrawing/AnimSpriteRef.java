...
/** An {@link AnimSpriteRef} holds an {@link Animation} and sets the {@link Texture} of its super type {@link Sprite} to the correct one according to the information in the {@link Animation}.<br>
 *  Usage:
 ...
 *  @author dermetfan */
public class AnimSpriteRef extends Sprite {
    ...
    /** creates a new {@link AnimSpriteRef} with the given {@link Animation}
     *  @param animation the {@link #animation} to use */
    public AnimSpriteRef(Animation<TextureRegion> animation) {
        super(animation.getKeyFrame(0));
        this.animation = animation;
    }

    /** updates the {@link AnimSpriteRef} with the delta time fetched from {@link Graphics#getDeltaTime()  Gdx.graphics.getDeltaTime()} */
    public void update() {
        update(Gdx.graphics.getDeltaTime());
    }

    /** updates the {@link AnimSpriteRef} with the given delta time */
    ...
    /** @return if this {@link AnimSpriteRef} is playing */
    public boolean isPlaying() {
        return playing;
    }

    /** @param playing if the {@link AnimSpriteRef} should be playing */
