 ...
 */
public class Coins_Val_Coll extends Statistic {
    private final ERQGame game;

    public Coins_Val_Coll(ERQGame game){
        super(LANG.format("statistic_collected_coin_value"));
        this.game = game;
    }

    @Override
    public String getStatValue() {
        return "" + game.getAchievementVerwalter().getStat(AVars.OVERALL_COLLECTED_COINS_VALUE);
    }
}
