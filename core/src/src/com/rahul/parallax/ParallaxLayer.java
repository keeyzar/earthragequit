 ...
 * <p>
 * As an example, consider you need to render 20 colored dots per camera viewport width over background. The balls need to scroll with the world camera, but with the src.com.rahul.parallax effect . Now you can extend this class to create your own balls layer with internal logic to maintain the balls(logically) and render them.
 * @author Rahul Verma
 *
 */
public abstract class ParallaxLayer {
	...
	/**
	 * if you need one time update (e.g. particle Effect), then override this.
	 */
	public void update() {
	}
    ...
    /**
     * get the Vector2 that contains the src.com.rahul.parallax scrolling ratio of this layer in x and y direction.
     * @return src.com.rahul.parallax scrolling ratio
     */
	...
	/**
     * set the src.com.rahul.parallax scrolling ratio of this layer in x and y direction.
     * @return src.com.rahul.parallax scrolling ratio
     */
