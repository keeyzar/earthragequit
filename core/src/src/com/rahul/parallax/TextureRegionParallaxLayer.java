...
/**
 * 
 * TextureRegionParallaxLayer is the direct extension of {@link ParallaxLayer}. It represents a layer in the src.com.rahul.parallax scrolling background with just one texture region per layer . It still is very nifty and useful as it encapsulates the logic of padding in all the directions.
...
public class TextureRegionParallaxLayer extends ParallaxLayer {
	 ...
	 */
	public TextureRegionParallaxLayer(TextureRegion texRegion, float oneDimen, Vector2 parallaxScrollRatio, src.com.rahul.parallax.Utils.WH wh){
		this.texRegion = texRegion;
		switch(wh){
		    case width:
		    	setRegionWidth(oneDimen);
		    	setRegionHeight(src.com.rahul.parallax.Utils.calculateOtherDimension(src.com.rahul.parallax.Utils.WH.width, oneDimen, this.texRegion));
		    	break;
		    case height:
		    	setRegionHeight(oneDimen);
		    	setRegionWidth(src.com.rahul.parallax.Utils.calculateOtherDimension(src.com.rahul.parallax.Utils.WH.height, oneDimen, this.texRegion));
		    	break;
		}
		setParallaxRatio(parallaxScrollRatio);
	}
